...
const val CORRECT_USERNAME = "Zaphod"
...
fun main() {
    ...
    if (userName != CORRECT_USERNAME) {
        println("Вас нет в системе. Хотите зарегистрироваться?")
    } else {
        ...
        if (password != CORRECT_PASSWORD) {
            ...
            println(
                ...
                Пользователь $CORRECT_USERNAME, вам разрешено входить на борт корабля "Heart of Gold". 
