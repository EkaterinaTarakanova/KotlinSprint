...
fun main() {
    ...
    val hullDamage: Boolean = readln().toBoolean()
    ...
    val canSail = (hullDamage == false &&  currentCrewNumber in MIN_CREW_NUMBER..MAX_CREW_NUMBER
            && currentBoxesOfProvisions > BOXES_OF_PROVISIONS)
            || (hullDamage == true && currentCrewNumber == MAX_CREW_NUMBER
            && weatherConditions == true && currentBoxesOfProvisions >= BOXES_OF_PROVISIONS)
